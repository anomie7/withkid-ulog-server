...
public class EventLogController {
    ...
    public ResponseEntity<Quration> getRecentEventLog(@RequestHeader(name = "Authorization") String accessToken) throws AuthorizationUnavailableException {
    ...
    public ResponseEntity<String> setEventhLog(@RequestHeader(name = "Authorization") String accessToken, @RequestBody EventLog eventLog) throws ExecutionException, InterruptedException, AuthorizationUnavailableException {
